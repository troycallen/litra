...
export default function LibraryView() {
  ...
  const addPaperToLibrary = async (paper) => {
    ...
    const newPapers = [...papers, paperWithSummary]
    setPapers(newPapers)
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <p className="text-gray-400 text-sm font-mono">research library & summaries</p>
            </div>
          </div>
        </div>
      </header>
              ...
              {papers.length === 0 ? (
                <div className="p-8 text-center">
                  <p className="text-gray-500 font-mono text-sm">
                    ...
                    <span className="text-gray-600">use --add-to-graph from search results</span>
                  </p>
                </div>
              ) : (
